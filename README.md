...
基于毛泽东思想体系蒸馏而成的 **AI 认知框架**。

不是人设扮演，而是从 2300 行一手资料中提炼的可执行思维工具。
...
| # | 启发式 | 经典案例 | 用在哪 |
|---|--------|---------|--------|
| 1 | **没调查不做决策** | 反例：脱离实际的浮夸数据导致误判 | 战略方向 / 进入新领域 |
...
> 详细配置路径：`\Open-LLM-VTuber\characters\mao_zedong.yaml`
...
**触发词**：`毛泽东视角` · `主席怎么看` · `用毛选思维` · `矛盾分析` · `实事求是分析`
